...
export LOG_ANALYTICS_WORKSPACE_ID=22a588b9-450e-4f0c-b956-6f19a57499af
export LOG_ANALYTICS_WORKSPACE_KEY=IzQ6ZftTpYeYuKYrChxkMG8Aw5D8g3zKcDR9iE7aQrkE1ryfneGWm82mYlwfI2yGG5OqzraqU299gjkKSyC0Bw==
export AZ_SUBSCRIPTION_ID=75b6ce6a-07e6-426e-a504-4ef5dfc14b62
export AZ_RSRC_GRP_NAME=lab-databricks
export AZ_RSRC_PROV_NAMESPACE=Microsoft.Databricks
export AZ_RSRC_TYPE=workspaces
export AZ_RSRC_NAME=databricks-teste-raquel
